...
<head>
    ...
    <!--Meta tags start-->
    <meta charset="UTF-8">
    <meta name="description" content="Smart Traffic Fine Management System for DBMS Mini Project">
    <meta name="keywords" content="Traffic, Fine, System, India">
    <meta name="author" content="PES University">
            ...
            <div class="container animated fadeIn">
                <div class="row">
                    <div class="footer-col">
                        ...
                        <ul>
                            <li><a href="tel:+94714590249"><i class="fas fa-phone"></i> +91 7028029384</a></li>
                        </ul>
                    </div>
                    <div class="footer-col">
