...
<script>
    function payDone(ref_no) {
        // Your code to handle the deleteOrder action
        window.location.href = "payDone.php?ref_no=" + ref_no;
        // alert('Payment Done');
        ...
        <div class="container-fluid d-flex align-items-center justify-content-center">
            <div class="col-md-6">
                ...
                <!-- <form method="post" action="">
                    ...
                    <input type="hidden" name="merchant_id" value="1217671">   
                ...
                <div class="model-footer text-right mr-4 mt-4">
                            ...
                            <!-- <input type="submit" value="Confirm Pay" class="btn btn-primary"> -->
                            <?php
                                    echo '<button type="submit" onclick="payDone(\''.$row['ref_no'].'\')">Confirm Pay</button>';
                                    ?>
                        </div>
                <?php
                }?>
